...
export const chatFlow: ChatStep[] = [
  ...
  },
  {
    ...
    sender: 'bot',
    type: 'quick-reply',
    content: "Entendi, minha flor. Falar que você está **100% satisfeita** com seu corpo quando usa uma roupa ou quando vê a gordura da barriga marcando, se eu falar que você está feliz, é mentira, né isso?",
